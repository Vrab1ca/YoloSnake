...
namespace YoloSnake.Models
{
    ...
    public class Snake : IPlayable
    {
        ...
        private LinkedList<IPosition> positions; // Linked list allows efficient adding/removing from both ends
        ...
        {
            // Prevent the snake from turning 180 degrees into itself
            switch (newDirection)
            {
                ...
                case Direction.Right: if (this.Direction != Direction.Left) this.Direction = newDirection; break;
        ...
        public void Move() 
        {
            // Movement logic: Remove the tail and add a new head in the current direction
        ...
        public void Draw(IDrawer drawer)
        {
            ...
            // Clear the old tail position visually after moving
